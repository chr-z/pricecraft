// PriceCraft — i18n (EN / PT-BR). Canonical source: /locales/*.json.
...
(function () {
  ...
  function setLang(lang) {
    ...
    current = lang;
    try { localStorage.setItem('pc_lang', lang); } catch { /* ignore */ }
    applyStatic();
    document.dispatchEvent(new CustomEvent('pricecraft:langchange'));
  }
  ...
  window.PCI18N = { t, setLang, applyStatic, get lang() { return current; } };
})();
